...
if (manifest.artifact_inventory.length !== manifest.expected_ui_counts?.artifact_count) {
  throw new Error('Static build artifact inventory differs from the verified manifest count')
}
