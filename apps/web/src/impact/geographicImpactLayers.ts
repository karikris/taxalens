...
export const TAXALENS_IMPACT_INTERACTIVE_LAYER_IDS = Object.freeze([
  TAXALENS_BASELINE_EVIDENCE_LAYER_ID,
  TAXALENS_FLICKR_PENDING_LAYER_ID,
  TAXALENS_FLICKR_REVIEWED_POSITIVE_LAYER_ID,
  TAXALENS_FLICKR_REVIEWED_NEGATIVE_LAYER_ID,
  TAXALENS_FLICKR_UNCERTAIN_LAYER_ID,
  TAXALENS_FLICKR_RELEASE_READY_LAYER_ID,
] as const)
