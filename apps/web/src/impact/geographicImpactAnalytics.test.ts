...
function impactRow(overrides: Record<string, unknown> = {}): Record<string, unknown> {
  return {
    ...
    baseline_excluded_occurrence_count: 0n,
    gbif_only_count: 0n,
    ...
    latest_baseline_event_date: null,
    latest_flickr_candidate_date: null,
    latest_reviewed_positive_date: null,
    latest_release_ready_date: null,
