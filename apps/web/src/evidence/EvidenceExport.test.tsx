...
describe('EvidenceExport', () => {
  it('prepares five downloadable audit files locally and labels the unsigned boundary', async () => {
    ...
    expect(await screen.findByText('Five audit files prepared locally')).toBeInTheDocument()
